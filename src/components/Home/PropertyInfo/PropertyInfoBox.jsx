...
const PropertyInfoBox = ({
  ...
  return (
    <div className={ `${backgroundColor} p-6 rounded-2xl mx-auto grid max-w-5xl grid-cols-1 gap-8 lg:grid-cols-12 border border-${backgroundColor} dark:border-primary-100` }>
      <h1 className='col-span-1 md:col-span-4 text-2xl font-bold'>{ heading }</h1>
      <div className='col-span-1 md:col-span-8'>
        <p className='text-edge md:text-2xl text-xl mb-4'>{ children }</p>
        <a
