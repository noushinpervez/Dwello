  ...
  const blogPosts = [
    {
      ...
      href: '#',
      imageUrl: 'https://i.postimg.cc/288nTmHK/5e8aa7deb81752a5cd240faf954d7bb8623b7f2a.png',
    },
    {
      id: 2,
      ...
      href: '#',
      imageUrl: 'https://i.postimg.cc/2jx443xW/b21b846b9e0f877852b8b810fb2a431c07c2650b.jpg',
    },
    {
      id: 3,
      ...
      href: '#',
      imageUrl: 'https://i.postimg.cc/FsW3Bq8s/da50cd88a732dadd923efc1a99c54eb795c7065a.png',
    },
  ];
    ...
    <section className='grid lg:grid-cols-2 grid-cols-1 items-center justify-between gap-12'>
      <div className='w-full flex justify-center flex-col py-28 px-16 md:p-28 m-auto gap-8 h-full'
        ...
        <p className='font-medium text-lg'>
          Advice from our experts to help you along your <span className='underline text-primary decoration-[#a2c4f6] decoration-wavy decoration-[3px] underline-offset-4 font-medium'>rental journey</span>.
        </p>
      </div>
      <div className='overflow-x-auto lg:overflow-x-hidden px-2 md:px-16 gap-12 flex lg:grid lg:grid-cols-1'>
